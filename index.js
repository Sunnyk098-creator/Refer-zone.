...
// --- CONFIGURATION ---
const BOT_TOKEN = '8643395116:AAGpTA74QTPUXyRmHCAjpH5vOFZ9luz-27E'; // 🆕 Updated Token
        ...
        if (userData.verified === true || userData.verified === "true") {
            ...
            if (userData.rewardGiven !== true && userData.referredBy && userData.referredBy !== false) {
                ...
                if (inviterSnap.exists()) {
                    ...
                    // 🆕 Updated instant notification format for successful verification
