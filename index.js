        ...
        if (isAdminUser) {
            ...
            try {
                if (state === 'ADD_CHANNEL') {
                    ...
                    // Support for Private Channels: Check if admin sent ID and LINK separated by space
                    if (val.includes(' ')) {
                        const parts = val.split(' ');
                        channelId = parts[0]; // e.g. -1001234567890
                        channelLink = parts[1]; // e.g. https://t.me/+xyz
                        ...
                        // Standard Public Channel Parsing
                        channelId = val;
                    ...
                    try {
                        ...
                        if (!['administrator', 'creator'].includes(memberInfo.status)) {
                            ...
                            // If private, save as "ID|LINK". If public, save as "@username"
